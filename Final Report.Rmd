...
Figure 2 shows the two ads used for the second pilot experiment. It uses an New York Times article about the drought on the West Coast.
...
```{r, echo=FALSE, fig.cap="Article 1", out.width = '75%', fig.align = "center", fig.pos = "H"}
knitr::include_graphics("images/article_1.png")
```


```{r, echo=FALSE, fig.cap="Article 2", out.width = '75%', fig.align = "center", fig.pos = "H"}
...
```{r, echo=FALSE, fig.cap="Survey Sample", out.width = '75%', fig.align = "center", fig.pos = "H"}
